    ...
    <div className="w-11/12 mx-auto">
      ...
      <section className="py-6 space-y-3">
        ...
        <p className="text-center w-11/12 mx-auto">
          Sign up to our newsletter and get €/£10 off your first order when you
          spend €/£100 or more! Plus, be the first to know about new product
          arrivals, exclusive offers, and the latest news from AllSportStore.
          Discount not applicable on sale items or promotions.
        </p>
            ...
            >
              <div className="p-6 flex flex-col items-center">
                ...
                <p className="text-gray-600 mt-2 px-4 text-center">
                  ...
                  valuable tool for anyone looking to advance their professional
                  journey
                </p>
              </div>
            </div>
            ...
            >
              <div className="p-6 flex flex-col items-center">
                ...
                <p className="text-gray-600 mt-2 px-4 text-center">
                  ...
                  straightforward, making it easy to search and apply for jobs.
                  I particularly appreciate the personalized recommendations,
                  which align perfectly with my skills and career goals. The
                  additional resources, like webinars and skill-building
                  courses, are a nice bonus. It's clear the team behind this
                  website understands what job seekers need. I’ve already
            ...
            >
              <div className="p-6 flex flex-col items-center">
                ...
                <p className="text-gray-600 mt-2 px-4 text-center">
                  ...
                  search filters save so much time, and I’ve found roles I never
                  would’ve considered before. The site also offers salary
                  insights and company reviews, which gave me confidence during
                  interviews. Thanks to this platform, I landed my dream job in
                  just two months!
                </p>
              </div>
            </div>
